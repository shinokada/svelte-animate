...
const description =
	'Svelte-Animate includes a customizable animation wrapper and interactive SVG icons with options for triggers, duration, size, color, and accessibility features.';
