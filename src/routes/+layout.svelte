<script lang="ts">
  ...
  import { Navbar, NavLi, NavBrand, NavUl, uiHelpers, DarkMode, Dropdown, DropdownItem, NavHamburger } from 'flowbite-svelte';
...
>
  ...
  >
    <NavLi href="/guide">Guide</NavLi>
    <NavLi href="/animator">Animator</NavLi>
    <NavLi href="/animations">Animations</NavLi>
    <NavLi href='https://svelte-animated-icons.codewithshin.com/' target="_blank">Animated icons</NavLi>
  </NavUl>
</Navbar>
